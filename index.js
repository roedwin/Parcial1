...
function costoTotal(precioHora,personas,horasTrabajas, materiales) {
    ...
    if (precioHora <= 0 || personas <= 0) {
        ...
        var pagoBruto = (horasPagadas.pagoMes(precioHora,horasTrabajas))*4;
        var hol = horasPagadas.holgura(precioHora,horasTrabajas);
        var cobro = horasPagadas.pagos(precioHora,personas,horasTrabajas);
...
function resolverRectangulo(l,b) {
    console.log("Resolver el rectángulo con = l " + l + " y b = " + b);
    if (l <= 0 || b <= 0) {
        console.log("Las dimensiones del rectángulo deben ser mayores a cero:  l = "
               + l + ",  and b = " + b);
    }
    else {
	    console.log("El area del rectangulo es: " + rectangulo.area(l,b));
	    console.log("El perimetro del rectángulo es: " + rectangulo.perimetro(l,b));
    }
}
resolverRectangulo(2,4);
resolverRectangulo(3,5);
resolverRectangulo(0,5);
resolverRectangulo(-3,5);*/